                  ...
                  <table cellpadding="0" cellspacing="0" class="table_search" summary="프로그램관리 검색">
                     ...
                     <tr>
                         <th scope="row">직원검색</th>
                                <td>     
                                   <input name="ad_search_word" id="ad_search_word" title="이름을 입력하세요." placeholder="이름을 입력하세요." type="text" style="width:200px" value="${param.ad_search_word}"  onkeydown="if (event.keyCode === 13) btn_program_get_list();"/>                        
                                   <!-- 
                  ...
                  <div class="list_zone">
                     <table cellspacing="0" border="0" summary="프로그램관리 리스트">
                        ...
                        <tbody>
                           ...
                           <c:forEach items="${userList}"  begin="0" end="${pagerRS}"  step="1"  var="userList" varStatus="status">
                              <tr>
                                 <td >${userList.PK}</td> 
